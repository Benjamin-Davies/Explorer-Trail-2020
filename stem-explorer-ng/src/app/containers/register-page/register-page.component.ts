...
export class RegisterPageComponent {
  ...
  get emailError(): boolean {
    return this.registerForm.controls.email.hasError('email') && this.registerForm.controls.email.touched;
  }

  get passwordError(): boolean {
    return (
      this.registerForm.controls.password.hasError('invalidPassword') && this.registerForm.controls.password.touched
    );
  }

  get passwordMatchError(): boolean {
    return (
      this.registerForm.controls.confirmPassword.hasError('passwordMismatch') &&
